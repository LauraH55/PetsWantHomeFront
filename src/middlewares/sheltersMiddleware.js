...
const URL_FETCH_SHELTERS = 'http://localhost/Projets/PetsWantHomeBack/public/api/shelters';
const MODIFICATION_URL = 'http://localhost/Projets/PetsWantHomeBack/public/api/shelter/update';
const URL = 'http://localhost/Projets/PetsWantHomeBack/public/api';
const API_URL = 'http://localhost/Projets/PetsWantHomeBack/public/api';
